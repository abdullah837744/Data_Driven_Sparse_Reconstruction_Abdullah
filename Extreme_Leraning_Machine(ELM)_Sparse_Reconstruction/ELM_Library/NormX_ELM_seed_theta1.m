function [TrainingTime,TrainingAccuracy,InputWeight,OutputWeight,H,Y] = NormX_ELM_seed_theta1(TrainingData_File,Elm_Type, NumberofHiddenNeurons, ActivationFunction,Feature,seed)
